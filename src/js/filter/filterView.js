...
export function render(params){
    ...
    const markup = ` <form method="GET" id="filter-form" class="container p-0">
...
export function changeButtonText(number){
    const filterSubmit = document.getElementsByClassName('filter__show')[0]
    ...
    filterSubmit.disabled = number === 0 ? true: false
}
...
export function getInput(){
    ...
    // Значения инпутов площадь и цена
